...
namespace LogixForms.HelperClasses
{
    ...
    public class CheckingTheCorrectness(ushort MAX_WORDS_NUM, ushort MAX_MESS_SIZE, ushort TIMER_MAX, CheckingType checkingType)
    {
        ...
        private ushort MAX_WORDS_NUM = MAX_WORDS_NUM;
        private ushort MAX_MESS_SIZE = MAX_MESS_SIZE;
        private ushort TIMER_MAX = TIMER_MAX;

        private ushort[] CheckKey = new ushort[MAX_WORDS_NUM];
        private string[] com_str = [];
        private CheckingType checking = checkingType;
